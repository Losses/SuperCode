...
2. Select **Regression** > **Recode Variables** from the analysis menu.
...
5. Inspect the **Recode Variables Preview** table to see exactly what comparisons are being set up.
